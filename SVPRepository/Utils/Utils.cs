...
namespace SVPRepository.Utils
{
    public class Utils
    {
        public static int GetNextSecuentialId(int pintNodeId, int pintTableId)
        {
            SigesoftDesarrollo_2Entities dbContext = new SigesoftDesarrollo_2Entities();
            ...
            else
            {
                ...
                dbContext.secuential.Add(objSecuential);
            }
        ...
        public static void SaveLog(string pintNodeId, string pintOrganizationId, string pintSystemUserId, LogEventType pEnuEventType, string pstrProcess, string pstrItem, Success pEnuSuccess, string pstrErrorMessage)
        {
            ...
            objEntity.v_LogId = GetNewId(intNodeId, Utils.GetNextSecuentialId(intNodeId, 7), "LV"); ;
            dbContext.log.Add(objEntity);
            dbContext.SaveChanges();
        }
        ...
        //public static int UsuarioNuevoId()
        //{
        //    //try
        //    //{
        //    SigesoftDesarrollo_2Entities dbContext = new SigesoftDesarrollo_2Entities();

        //    var correlativo = (from a in dbContext.getSystemUserCorrelativo()
        //                       select new systemuserDto
        //                       {
        //                           i_SystemUserId = a.i_SystemUserId
        //                       }).FirstOrDefault();

        //    return correlativo.i_SystemUserId;
        //    //}
        //    //catch (Exception ex)
        //    //{
        //    //   return null;
        ...
        //        var query = (from a in dbContext.getservicebypersonforcombo_sp(v_PersonId)
        ...
        //public static List<KeyValueDTO> GetServiceByHospForCombo(ref OperationResult pobjOperationResult, string v_HospId)
        //{
        //    try
        //    {
        //        SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel();

        //        var query = (from a in dbContext.getservicebyhospforcombo_sp(v_HospId)
        //                     select new KeyValueDTO
        //                     {
        //                         Id = a.Id,
        //                         Value1 = a.Value1,
        ...
        //public static List<KeyValueDTO> GetProtocolsByOrganizationForComboDCC(ref OperationResult pobjOperationResult, string v_CustomerOrganizationId, string v_CustomerLocationId, string pstrSortExpression)
        //{
        //    //mon.IsActive = true;
        ...
        //        //    where (a.v_CustomerOrganizationId == v_CustomerOrganizationId) &&
        //        //          (a.v_CustomerLocationId == v_CustomerLocationId) &&
        //        //          (a.i_IsDeleted == 0 && a.i_IsActive == 1)
        //        //    select a;

        //        var query = from a in dbContext.protocol
        //                    where (a.i_MasterServiceTypeId != 1) &&
        //                          (a.i_IsDeleted == 0 && a.i_IsActive == 1)
        //                    select a;
        ...
        //public static List<KeyValueDTO> GetSystemParameterForCombo_OLD(ref OperationResult pobjOperationResult, int pintGroupId, string pstrSortExpression)
        //{
        //    //mon.IsActive = true;
        ...
        //        List<KeyValueDTO> query = (from a in dbContext.getsystemparameterforcombo_sp(pintGroupId)
        //                                   select new KeyValueDTO
        //                                   {
        //                                       Id = a.Id.ToString(),
        //                                       Value1 = a.Value1,
        ...
        //public static List<KeyValueDTO> GetDataHierarchyForCombo_OLD(ref OperationResult pobjOperationResult, int pintGroupId, string pstrSortExpression)
        //{
        //    //mon.IsActive = true;
        ...
        //        List<KeyValueDTO> query = (from a in dbContext.getdatahierarchyforcombo_sp(pintGroupId)
        //                                   select new KeyValueDTO
        //                                   {
        //                                       Id = a.Id.ToString(),
        //                                       Value1 = a.Value1,
        ...
        //    {
        //        SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel();
        //        var query = (from A in dbContext.getjoinorganizationandlocation_list_sp(pintNodeId)
        //                     select new KeyValueDTO
        //                     {
        //                         Id = A.Id,
        //                         Value1 = A.Value1
        ...
        //        List<KeyValueDTO> KeyValueDTO = query.OrderBy(p => p.Value1).ToList();
        ...
        //public static List<KeyValueDTO> GetGrupoExamen(ref OperationResult pobjOperationResult, int? padre)
        //{
        //    //mon.IsActive = true;
        //    try
        //    {
        ...
        //        var query = (from b in dbContext.systemparameter
        //                     where b.i_IsDeleted == 0 && b.i_GroupId == 116 && b.i_ParentParameterId == padre
        //                     select b).AsEnumerable().Distinct()
        //            .Select(x => new KeyValueDTO
        //            {
        //                Id = x.i_ParameterId.ToString(),
        ...
        //        List<KeyValueDTO> query = (from a in dbContext.getdatahierarchyforcombodepartamento_sp(pintGroupId)
        //                                   select new KeyValueDTO
        //                                   {
        //                                       Id = a.Id.ToString(),
        //                                       Value1 = a.Value1,
        ...
        //        List<KeyValueDTO> query = (from a in dbContext.getdatahierarchyforcomboprovincia_sp(pintGroupId, pintParentItemId)
        //                                   select new KeyValueDTO
        //                                   {
        //                                       Id = a.Id.ToString(),
        //                                       Value1 = a.Value1,
        ...
        //        List<KeyValueDTO> query = (from a in dbContext.datahierarchy
        //                                   where a.i_GroupId == pintGroupId && a.i_IsDeleted == 0
        //                                   orderby a.v_Value1
        //                                   select new KeyValueDTO
        //                                   {
        ...
        //        List<KeyValueDTO> query = (from a in dbContext.getdatahierarchyforcombodistrito_1_sp(pintGroupId)
        //                                   select new KeyValueDTO
        //                                   {
        //                                       Id = a.Id.ToString(),
        //                                       Value1 = a.Value1,
        ...
        //    try
        //    {
        //        //tabla temporal en metodo ve store procedure
        //        var dbContext = new SigesoftEntitiesModel();

        //        var listParameters = (from A in dbContext.getsystemparameterforcomboformeso_sp()
        //                              select new KeyValueDTO
        //                              {
        //                                  GrupoId = 0,
        //                                  Id = A.i_ParameterId.ToString(),
        ...
        //public static List<GroupParameter> GetSystemParameterForComboForm_OLD(ref OperationResult pobjOperationResult, string form)
        //{
        //    try
        //    {
        //        SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel();
        ...
        //        var listParameters = (from a in dbContext.getsystemparameterforcomboform_sp(form)
        //                              select new KeyValueDTO
        //                              {
        //                                  GrupoId = a.GrupoId,
        //                                  Id = a.Id.ToString(),
